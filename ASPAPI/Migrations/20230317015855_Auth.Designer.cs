...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPAPI.Models.Domain.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ASPAPI.Models.Domain.User_Role", b =>
                {
                    b.HasOne("ASPAPI.Models.Domain.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASPAPI.Models.Domain.User", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("ASPAPI.Models.Domain.Walk", b =>
                {
                    b.HasOne("ASPAPI.Models.Domain.Region", "Region")
                        .WithMany("Walks")
                        .HasForeignKey("RegionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASPAPI.Models.Domain.WalkDifficulty", "WalkDifficulty")
                        .WithMany()
